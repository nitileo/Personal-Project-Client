...
const AddProduct = () => {
  ...
  const actionCreateProduct = useAdminStore(
    (state) => state.actionCreateProduct
  );
  ...
  const handleSubmit = async (e) => {
    try {
      ...
      if (isNaN(formData.price) || isNaN(formData.amount)) {
        return toast.error("Price and amount must be numeric values.");
      }
      ...
      await actionCreateProduct(token, formData);
      setFormData({
        title: "",
        description: "",
        price: "",
